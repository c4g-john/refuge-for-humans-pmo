...
- **RFH-PR-013** (traces: RFH-BR-006): The verification service shall target 99.9% uptime, and when the backend is unavailable the client-side score alone shall determine the verdict, so that verification is never the reason publishing stalls.
